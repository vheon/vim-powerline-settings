...
call Pl#Hi#Allocate({
    ...
    \ 'base02'         : ["Black", 0x073642],
    \ 'base01'         : ["LightGreen", 0x586e75],
    \ 'base00'         : ["LightYellow", 0x657b83],
    \ 'base0'          : ["LightBlue", 0x839496],
    \ 'base1'          : ["LightCyan", 0x93a1a1],
    \ 'base2'          : ["LightGray", 0xeee8d5],
    \ 'base3'          : ["White", 0xfdf6e3],
    \ 'yellow'         : ["DarkYello", 0xb58900],
    \ 'orange'         : ["LightRed", 0xcb4b16],
    \ 'red'            : ["DarkRed", 0xdc322f],
    \ 'magenta'        : ["DarkMagenta", 0xd33682],
    \ 'violet'         : ["LightMagenta", 0x6c71c4],
    \ 'blue'           : ["DarkBlue", 0x268bd2],
    \ 'cyan'           : ["DarkCyan", 0x2aa198],
    \ 'green'          : ["DarkGreen", 0x859900],
    \ })
